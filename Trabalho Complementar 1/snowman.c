...
void RenderScene(void){  
    ...
    glRotatef(90,1.2f, 0.0f, 0.0f);
	gluDisk(pObj, 0.0f, 0.4f, 26, 26);
	glPopMatrix();

	// BOCA (black)
	glColor3f(0.0f, 0.0f, 0.0f);  
	glPushMatrix();
		glTranslatef(-0.10f, 0.93f, 0.2f);
		gluSphere(pObj, 0.02f, 26, 13);  
	glPopMatrix();  
	glPushMatrix();
		glTranslatef(0.10f,  0.93f, 0.2f);
	...
	glColor3f(1.0f, 0.4f, 0.51f);  
	glPushMatrix();
		glTranslatef(0.27f, 0.7f, 0.0f); 
        glRotatef(90,1.2f, 1.2f, 0.0f); 
		gluCylinder(pObj, 0.02f, 0.02f, 0.5f, 26, 13); 
        glRotatef(90,1.2f, 0.0f, 0.0f); 
	glPopMatrix();  
	glPushMatrix();
		glTranslatef(-0.27f, 0.7f, 0.0f);
